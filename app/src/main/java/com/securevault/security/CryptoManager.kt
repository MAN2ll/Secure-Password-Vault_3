...
class CryptoManager @Inject constructor() {
    ...
    private fun getOrCreateKey(): SecretKey {
        ...
        return KeyGenerator.getInstance(KeyProperties.KEY_ALGORITHM_AES, "AndroidKeyStore").also {
            it.init(
                KeyGenParameterSpec.Builder("SecureVaultKey", KeyProperties.PURPOSE_ENCRYPT or KeyProperties.PURPOSE_DECRYPT)
    ...
    fun decryptString(data: String): String {
        ...
        return cipher.doFinal(enc).toString(Charsets.UTF_8)
    }
